...
--Q2. Which customers used aq discount but still spent more than the average purchase amount?
SELECT
   customer_id, 
   purchase_amount
FROM customer
...
--Q5. Do subscribed customers spend more? Compare average spend and revenue
